...
for (i in 1:length(modules)) {
  ...
  sas_v %>% str_subset(paste0("-m", module, "-")) -> sas_v_subset
  filename <- str_replace("../modules/5508-xx-handouts.md", "xx", module)

  vlist <- sort(c(rmd_v_subset, sas_v_subset))
  ...
  paste0("<!--resources-slides-1-->\n") %>%
    ...
    paste0("\n\n") %>%
    paste0("Here are R and SAS programs used in the videos.\n") %>%
    paste0("\n", bullet(rmd_v_subset)) -> resources_slides_1
  ...
  paste0("\n\n<!---pdf_v--->") %>%
    ...
    paste0("\n\n<!---vlist--->") %>%
    paste0("\n", add_links(vlist, "", "src/")) -> resources_slides_2
