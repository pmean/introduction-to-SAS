...
+ V01-03. Your first SAS program (10 minutes). 
  ...
  + Slides with speaker notes are not available.
  + your-first-program.sas is available in [text format](https://github.com/pmean/introduction-to-SAS/tree/master/basics1/src/getting-started.sas).

+ V01-04. Storing SAS datasets using libname (xx minutes). 
